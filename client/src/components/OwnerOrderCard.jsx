  ...
  return (
    <div className="bg-white rounded-lg shadow p-4 space-y-4">
      ...
      <div className="flex space-x-4 overflow-auto pb-2">
              {data.shopOrders?.[0].shopOrderItem.map((item, index) => (
                <div
                  key={index}
            ...
            <select className="rounded-md border px-3 py-1 border-[#ff4d2d] text-[#ff4d2d] text-sm focus:outline-none focus:ring-2 " name="" id="" value={data.shopOrders?.[0].status}>
