  ...
  return (
    <div className='w-full min-h-screen  bg-[#fff9f6] flex flex-col items-center'>
      ...
      <div className='flex  justify-center items-center p-4 sm:p-6'>
        <div className='w-full max-w-md bg-white shadow-lg rounded-2xl p-6 border border-gray-100 hover:shadow-xl transition-shadow duration-300'>
          <div className='flex flex-col items-center text-center'>
            ...
            <p className='text-gray-600 mb-4 text-sm sm:text-base'>Join our platform and server your taste</p>
      ...
      <div className='w-full flex flex-col items-center gap-6 px-4 sm:px-6'>
       ...
       <h1 className='text-2xl sm:text-3xl text-gray-900 flex items-center gap-3 mt-8 text-center'><FaUtensils className='text-[#ff4d2d] w-14 h-14 sm:w-20 sm:h-20 mb-4' />Welcome {myShopData.name}</h1>
     <div className='bg-white shadow-lg rounded-xl overflow-hidden border border-orange-100 hover:shadow-2xl transition-all duration-300 w-full max-w-3xl relative'>
      ...
      >
        ...
        <h1 className='text-xl font-bold text-gray-800 mb-2'>{myShopData.name}</h1>
      ...
      {myShopData?.items?.length === 0 && 
       <div className='flex  justify-center items-center p-4 sm:p-6'>
        <div className='w-full max-w-md bg-white shadow-lg rounded-2xl p-6 border border-gray-100 hover:shadow-xl transition-shadow duration-300'>
          <div className='flex flex-col items-center text-center'>
            <FaUtensils className='text-[#ff4d2d] w-16 h-16 sm:w-20 sm:h-20 mb-4' />
            <h2 className='text-xl font-bold text-gray-800 mb-2'>Add Dishes</h2>
            <p className='text-gray-600 mb-4 text-sm sm:text-base'>Share your delicious dishes to our customers by adding it to the menu</p>
            <button onClick={() => navigate('/add-food')} className='bg-[#ff4d2d] text-white px-5 sm:px-6 py-2 rounded-full font-medium shadow-md hover:bg-orange-600 transition-colors duration-200'>
              Add food
            </button>
          </div>
        </div>
