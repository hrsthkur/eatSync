...
const dispatch = useDispatch()
 ...
 const navigate = useNavigate()
  return (
    <div className='flex bg-white rounded-lg shadow-md overflow-hidden border mt-6 border-[#ff4d2d] w-full max-w-2xl'>
      ...
      <div className='flex flex-col justify-between p-3 flex-1 '>
        <div>
          ...
          <p><span className='font-medium text-gray-700'>Food Type: :</span> {data.type}</p>

        </div>
        <div className='flex items-center justify-between'>
          <div className='text-[#ff4d2d] font-bold'>{data.price}</div>
          <div className='flex items-center gap-2'>
            <div className='cursor-pointer p-2 rounded-full hover:bg-[#ff4d2d]/10 text-[#ff4d2d]' onClick={()=> navigate(`/edit-item/${data._id}`)}>
               <FaPen size={16}/>
